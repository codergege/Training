...
<title>学员信息 excel 导入</title>
</head>
<body>
	<h1 style="text-align: center;">学员信息 excel 导入</h1>
	<div style="width: 600px; height: 200px; border: 1px solid blue; margin: 0 auto; padding: 5px;">
		<s:form action="candidate-importExcel" method="post" enctype="multipart/form-data" theme="simple">
